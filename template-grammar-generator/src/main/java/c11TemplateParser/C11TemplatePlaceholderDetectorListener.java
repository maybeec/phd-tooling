 ...
 */
public class C11TemplatePlaceholderDetectorListener extends C11TemplateBaseListener {
     ...
     * Default Constructor
     */
    public C11TemplatePlaceholderDetectorListener() {
        super();
        try {
            ...
            C11TemplateParser parser = new C11TemplateParser(null);
            Class<? extends C11TemplateParser> parserClass = parser.getClass();
