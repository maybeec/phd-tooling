...
import antlr4Parser.ANTLRv4Parser.AlternativeContext;
import antlr4Parser.ANTLRv4Parser.EbnfSuffixContext;
import antlr4Parser.ANTLRv4Parser.GrammarSpecContext;
import antlr4Parser.ANTLRv4Parser.LexerAltListContext;
import antlr4Parser.ANTLRv4Parser.LexerAtomContext;
import antlr4Parser.ANTLRv4Parser.LexerRuleSpecContext;
import antlr4Parser.ANTLRv4Parser.ParserRuleSpecContext;
import antlr4Parser.ANTLRv4Parser.RangeContext;
import antlr4Parser.ANTLRv4Parser.RulerefContext;
...
public class ObjectLanguageListener extends ANTLRv4ParserBaseListener {
    ...
    private void analyzeMaybeSequenceParserRules() {
        ...
        if (!maybeSequenceParserRules.isEmpty()) {
            System.out.println("Could not find out whether the following parser rules contain sequences: "
                + maybeSequenceParserRules);
        }
    }
    ...
    private boolean isMultiple(ParseTree tree) {
        ...
        for (ParseTree child : children) {
            ...
            if (child instanceof LexerAtomContext && child.getText().startsWith("[")
                && child.getText().endsWith("]")) {
