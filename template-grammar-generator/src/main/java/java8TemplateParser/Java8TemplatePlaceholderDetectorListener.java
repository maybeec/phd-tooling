 ...
 */
public class Java8TemplatePlaceholderDetectorListener extends Java8TemplateBaseListener {
     ...
     * Default Constructor
     */
    public Java8TemplatePlaceholderDetectorListener() {
        super();
        try {
            ...
            Java8TemplateParser parser = new Java8TemplateParser(null);
            Class<? extends Java8TemplateParser> parserClass = parser.getClass();
